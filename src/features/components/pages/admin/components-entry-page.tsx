...
const views = [
  {
    ...
    description: 'Revisa, edita y archiva componentes registrados.',
    href: '/admin/components/list',
    cta: 'Ver lista',
    icon: List,
  },
  {
...
export function ComponentsEntryPage() {
      ...
      <section className="lively-hero rounded-[var(--radius-panel)] px-6 py-7 sm:px-8 sm:py-9">
        <div className="relative z-10">
          ...
          <p className="mt-3 max-w-2xl text-sm leading-6 text-muted-foreground sm:text-base">
            Elige una accion para gestionar los componentes (repuestos, insumos, etc.).
          </p>
        </div>
      </section>
